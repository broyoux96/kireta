      ...
      <div class="container py-5">
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                  <?php
                            $sql = mysqli_query($koneksi, "select * from produk where kategoriprdk='other'");
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="lcd-battery.php?namamac=<?php echo $namaprdk; ?>" class="h3 text-decoration-none"> <?php echo $namaprdk; ?></a>
