      ...
      <div class="container py-5">
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                  <?php
                            $sql = mysqli_query($koneksi, "select * from ipad");
                            while ($row = mysqli_fetch_array($sql)) {
                              $namapad          = $row['namapad'];
                              $kerusakanpad     = $row['kerusakanpad'];
                              $deskpad          = $row['deskpad'];
                              $gambarpad        = $row['gambarpad'];
                              # code...
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="admin/img/service/ipad<?php echo $gambarpad; ?>">
                            ...
                            <div class="card-body">
                                <a href="lcd-battery.php?namamac=<?php echo $namapad; ?>" class="h3 text-decoration-none"> <?php echo $namapad; ?></a>
                                ...
                                <p class="text-center mb-0"><?php echo $kerusakanpad;?></p>
                            </div>
                        </div>
                    </div>
                    <?php
