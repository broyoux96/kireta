      ...
      <div class="container py-5">
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                  <?php
                            $sql = mysqli_query($koneksi, "select * from iphone");
                            while ($row = mysqli_fetch_array($sql)) {
                              $namaiphone     = $row['namaiphone'];
                              $kerusakaniphone    = $row['kerusakaniphone'];
                              $deskiphone     = $row['deskiphone'];
                              $gambariphone  = $row['gambariphone'];
                              # code...
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="admin/img/service/iphone<?php echo $gambariphone; ?>">
                            ...
                            <div class="card-body">
                                <a href="lcd-battery.php?namamac=<?php echo $namaiphone; ?>" class="h3 text-decoration-none"> <?php echo $namaiphone; ?></a>
                                ...
                                <p class="text-center mb-0"><?php echo $kerusakaniphone;?></p>
                            </div>
                        </div>
                    </div>
                    <?php
