      ...
      <div class="container py-5">
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                  <?php
                            $sql = mysqli_query($koneksi, "select * from iwatch");
                            while ($row = mysqli_fetch_array($sql)) {
                              $namawat          = $row['namawat'];
                              $kerusakanwat     = $row['kerusakanwat'];
                              $deskwat          = $row['deskwat'];
                              $gambarwat        = $row['gambarwat'];
                              # code...
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="admin/img/service/iwatch<?php echo $gambarwat; ?>">
                            ...
                            <div class="card-body">
                                <a href="lcd-battery.php?namamac=<?php echo $namawat; ?>" class="h3 text-decoration-none"> <?php echo $namawat; ?></a>
                                ...
                                <p class="text-center mb-0"><?php echo $kerusakanwat;?></p>
                            </div>
                        </div>
                    </div>
                    <?php
