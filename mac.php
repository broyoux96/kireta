      ...
      <div class="container py-5">
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                  <?php
                            $sql = mysqli_query($koneksi, "select * from mac");
                            while ($row = mysqli_fetch_array($sql)) {
                              $namamac     = $row['namamac'];
                              $tahunmac    = $row['tahunmac'];
                              $deskmac     = $row['deskmac'];
                              $gambarmac  = $row['gambarmac'];
                              # code...
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="admin/img/service/mac/<?php echo $gambarmac; ?>">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white mt-2" href="https://wa.me/6287730323400?text="><i class="fas fa-cart-plus"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="lcd-battery.php?namamac=<?php echo $namamac; ?>" class="h3 text-decoration-none"> <?php echo $namamac; ?></a>
                                ...
                                <p class="text-center mb-0"><?php echo $deskmac;?></p>
                            </div>
                        </div>
                    </div>
                    <?php
